...
:root {
  --artone-brand: ${color.brand};
  --artone-brand-subtle: ${color.brandSubtle};
  --artone-surface-0: ${color.surface0};
  --artone-surface-1: ${color.surface1};
  --artone-surface-2: ${color.surface2};
  --artone-surface-3: ${color.surface3};
  --artone-surface-4: ${color.surface4};
  --artone-text-1: ${color.textPrimary};
  --artone-text-2: ${color.textSecondary};
  --artone-text-3: ${color.textTertiary};
  --artone-border: ${color.border};
  --artone-border-focus: ${color.borderFocus};
  --artone-playhead: ${color.playhead};
  --artone-selection: ${color.selection};
  --artone-positive: ${color.positive};
  --artone-caution: ${color.caution};
  --artone-destructive: ${color.destructive};
  --artone-radius-sm: ${radius.sm}px;
  --artone-radius-md: ${radius.md}px;
  --artone-radius-lg: ${radius.lg}px;
  --artone-shadow-sm: ${shadow.sm};
  --artone-shadow-md: ${shadow.md};
  --artone-shadow-lg: ${shadow.lg};
  --artone-font-sans: ${typography.fontFamily.sans};
  --artone-font-mono: ${typography.fontFamily.mono};
  --artone-ease-out: ${motion.easeOut};
  --artone-spring: ${motion.spring};
  --artone-snappy: ${motion.snappy};
}
`;
